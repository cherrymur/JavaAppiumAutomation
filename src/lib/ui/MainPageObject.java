...
public class MainPageObject {
    ...
    public void assertElementHasText(String locator, String expected, String error_message) {
        WebElement title_element = waitForElementPresent(locator, "Cannot find an element", 15);
    ...
    public void assertElementsHaveText(String locator, String expected, String error_message) {
        List<WebElement> list_element = waitForElementsPresent(locator, error_message, 5);
    ...
    public void swipeUpToFindElement(String locator, String error_message, int max_swipe){
        ...
        while (driver.findElements(by).size() == 0) {
            if (already_swipe > max_swipe) {
                waitForElementPresent(locator, "Cannot find element by swiping uo. \n" + error_message, 0);
                return;
            }
            swipeUpQuick();
            ++already_swipe;
    ...
    public void clickElementToTheRightUpperCorner(String locator, String error_message) {
        ...
        // we go to the element upper than we founded with locator
        ...
        int point_to_click_x = (right_x + width) -3; //less for 3 px
    ...
    public void swipeToTheLeftElement(String locator, String error_message){
        WebElement element = waitForElementPresent(locator, "Cannot find element by swipe the element. \n"
                + error_message, 5);
